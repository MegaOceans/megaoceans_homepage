...
const PrivacyPolicy = () => {
  return (
    <div className=" bg-primary py-10">
      <div className="privacy-policy p-8 max-w-4xl mx-auto bg-terinary rounded-3xl">
        {/* <h1 className="text-2xl font-bold mb-4">Privacy Policy for megaoceans</h1> */}
        ...
        <p className="mb-1">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <li>
            <span className="font-bold">Country</span> refers to: Uttar Pradesh,
            India
          </li>
          <li>
          ...
          <li>
            <span className="font-bold">Website</span> refers to megaoceans,
            accessible from megaoceans.com
          </li>
          <li>
        ...
        <h4 className="text-base font-bold mb-2">Personal Data</h4>
        <p className="mb-2">
        ...
        <h4 className="text-base font-bold mb-2">Usage Data</h4>
        <p className="mb-2">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <li>
            <span className="font-bold">Web Beacons.</span> Certain sections of
        ...
        <h3 className="text-lg font-bold mb-2">Use of Your Personal Data</h3>
        <p className="mb-2">
        ...
        <h3 className="text-lg font-bold mb-2">Delete Your Personal Data</h3>
        <p className="mb-2">
        ...
        <h4 className="text-base font-bold mb-2">Business Transactions</h4>
        <p className="mb-4">
        ...
        <h4 className="text-base font-bold mb-2">Law enforcement</h4>
        <p className="mb-4">
        ...
        <h4 className="text-base font-bold mb-2">Other legal requirements</h4>
        <p className="mb-2">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-1">
          <li>By email: ishan@megaoceans.com</li>
        </ul>
